...
### Run MUSIC for Enriched Regions detection on Trimmed/mapped_qual=10/rmDup reads :

homedir="/home/kondmar/PROJECTS/ChIPseq/bam/Trimmed/Filtered/" 
output_dir="/home/kondmar/PROJECTS/ChIPseq/MUSIC_PeakCalling/"
...
##  Final merging of Unique and overlapping Peaks 
